        ...
        <div className="w-full bg-white rounded-xl p-6 px-40">
          <div className="flex items-center pb-6">
            <div className="flex items-center">
              <a
                href="#"
                className="text-sm bg-gray-400 hover:bg-gray-600 text-white rounded-md px-4 py-2"
              >
            ...
            <table className="w-full text-sm mx-auto ">
              ...
              <tbody>
                <tr className="odd:bg-white even:bg-red-50 border-b">
                  ...
                  <td className="px-6 py-4">01-02-2024 | 15:00:00</td>
                  <td className="px-6 py-4">Hayo habis ngapain wkwk</td>
                </tr>
                <tr className="odd:bg-white even:bg-red-50 border-b">
