...
const AddUser = () => {
    ...
    const onFinish = async (values) => {
        ...
        try {
            const response = await axios.post("http://iglo-cms-api.xyz/api/user-manage", values, {
                headers: {
        ...
        <div className="flex">
            ...
            <main className="w-full bg-red-50">
                ...
                <div className="my-8 mx-10">
                    ...
                    <Form form={form} name="addData" onFinish={onFinish} onFinishFailed={onFinishFailed} layout="vertical" className="bg-white p-8 rounded-lg" encType="multipart/form-data">
                        ...
                        <Form.Item label="Role" name="id_role" rules={[{ required: true, message: "Please select a role!" }]}>
